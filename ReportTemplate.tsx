    ...
    >
      ...
      <div className="flex justify-between items-end h-[35mm] mb-1">
        <div className="flex flex-col w-[65%]">
          ...
          <div className="mt-3">
            <p className="font-black text-gray-900 leading-none uppercase tracking-tight text-[13pt] truncate">
              {data.namaPenyedia || 'NAMA PENYEDIA'}
            </p>
            <p className="font-bold uppercase tracking-wide mt-1 text-[8.5pt] flex flex-wrap items-center">
              <span className={`${theme.text} font-black`}>{data.kategoriPenyedia}</span>
              {data.subKategoriPenyedia && data.subKategoriPenyedia !== 'Tidak Berkenaan' && (
                <>
                  <span className="mx-1 text-gray-400 font-normal">|</span>
                  <span className="text-gray-700">{data.subKategoriPenyedia}</span>
                </>
              )}
            </p>
            <p className="font-black text-gray-800 uppercase tracking-widest text-[7.5pt] mt-0.5">
